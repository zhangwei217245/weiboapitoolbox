...
public class MenuInGroups extends GenericForwardComposer {
    ...
    public void onClick$btn_save() throws InterruptedException {
        if (currentGroup != null) {
            ...
            final Component selcomp = this.self;
            Messagebox.show("保存成功！", "确认", Messagebox.OK, Messagebox.INFORMATION, new EventListener() {

                public void onEvent(Event event) throws Exception {
                    if (event.getName().equals("onOK")) {
                        Event closeEvent = new Event("onClose", selcomp, null);
